    ...
    def corrida(self):
        ...
        while True:
            ...
            if t_1 - t_0 >= self.intervalo_alinhamento:
                ...
                self.estado.trocar_estado(self.visao.checar_alinhamento_pista_v2(self.visao))  # Frente, GIRAR_ESQUERDA ou GIRAR_DIREITA
                numero_de_giradas = 1
                while self.estado.obter_estado_atual() == "GIRAR_DIREITA" or self.estado.obter_estado_atual() == "GIRAR_ESQUERDA":
                    ...
                    self.estado.trocar_estado(self.visao.checar_alinhamento_pista_v2(self.visao))
                    numero_de_giradas+=1
