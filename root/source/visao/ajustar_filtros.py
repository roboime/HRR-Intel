""" Programa para calibrar os ranges de cor utilizados para reconhecer a pista e os obstaculos pelo
    robo.
    Siga os passos para utiliza-lo:

    1 - Coloque o path correto da imagem na variavel global PATH.
    2 - Execute o programa. Abrira 4 imagens divididas numa janela que estara escrito a cor que deve
    ser mascarada a imagem e um track bar para ajustar os ranges.
    3 - Ajuste os ranges. Ao terminar, aperte Esc para passar para a proxima cor.
    4 - Repita o passo 3 ate o programa encerrar.
    
    O arquivo com os ranges estara salvo no mesmo diretorio com o nome ranges_<cor>.txt. O path para
    este arquivo pode ser passado no metodo mask() da Classe_imagem() para obter a mascara relativa
    a cor"""

import cv2
import numpy as np

PATH = "./data/images/input_imgs/imagem_main2.jpg"
CORES = ["LARANJA", "VERMELHO", "BRANCO", "PRETO"]
FILES = ["./data/filtros_de_cor/ranges_laranja.txt",
        "./data/filtros_de_cor/ranges_vermelho.txt",
        "./data/filtros_de_cor/ranges_branco.txt",
        "./data/filtros_de_cor/ranges_preto.txt"]
